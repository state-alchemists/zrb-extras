...
from zrb import Task, python_task, ResourceMaker, runner, IntInput, StrInput
from zrb.builtin.generator.common.task_input import (
    project_dir_input, app_image_name_input, env_prefix_input
)
...
from zrb.builtin.generator.project_task.task_factory import (
    create_ensure_project_tasks, create_add_deploy_upstream,
    create_add_destroy_upstream, create_add_remove_containers_upstream,
...
async def metabase(*args: Any, **kwargs: Any):
